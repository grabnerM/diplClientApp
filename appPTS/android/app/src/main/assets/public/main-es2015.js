...
/* harmony import */ var _components_course_course_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./components/course/course.component */ "./src/app/components/course/course.component.ts");
...
/* harmony import */ var _validators_username__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../validators/username */ "./src/app/validators/username.ts");
/* harmony import */ var _validators_password__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../validators/password */ "./src/app/validators/password.ts");
/* harmony import */ var _validators_email__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../validators/email */ "./src/app/validators/email.ts");
...
let AuthenticationComponent = class AuthenticationComponent {
    constructor(auth, router, storage, formBuilder) {
        this.auth = auth;
        this.router = router;
        ...
        this.registerFirstPage = formBuilder.group({
            ...
            rPassword: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_4__["Validators"].compose([_angular_forms__WEBPACK_IMPORTED_MODULE_4__["Validators"].required, _angular_forms__WEBPACK_IMPORTED_MODULE_4__["Validators"].pattern('^(?=.*)(?=.*[a-z])(?=.*[A-Z])(?=.*[a-zA-Z]).{8,}$')]), (control => _validators_password__WEBPACK_IMPORTED_MODULE_6__["PasswordValidator"].confirmPassword(control, this.registerFirstPage, 'cPassword'))],
            cPassword: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_4__["Validators"].compose([_angular_forms__WEBPACK_IMPORTED_MODULE_4__["Validators"].required]), (control => _validators_password__WEBPACK_IMPORTED_MODULE_6__["PasswordValidator"].confirmPassword(control, this.registerFirstPage, 'rPassword'))],
            sex: ['']
        }, {
            updateOn: "blur"
        });
        this.registerSecondPage = formBuilder.group({
            rEmail: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_4__["Validators"].compose([_angular_forms__WEBPACK_IMPORTED_MODULE_4__["Validators"].required, _angular_forms__WEBPACK_IMPORTED_MODULE_4__["Validators"].pattern('^[a-z0-9._%+-]+@[a-z0-9.-]+\\.[a-z]{2,4}$')]), (control => _validators_email__WEBPACK_IMPORTED_MODULE_7__["EmailValidator"].confirmEmail(control, this.registerSecondPage, 'cEmail'))],
            cEmail: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_4__["Validators"].compose([_angular_forms__WEBPACK_IMPORTED_MODULE_4__["Validators"].required, _angular_forms__WEBPACK_IMPORTED_MODULE_4__["Validators"].pattern('^[a-z0-9._%+-]+@[a-z0-9.-]+\\.[a-z]{2,4}$')]), (control => _validators_email__WEBPACK_IMPORTED_MODULE_7__["EmailValidator"].confirmEmail(control, this.registerSecondPage, 'rEmail'))],
...
AuthenticationComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! raw-loader!./authentication.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/components/authentication/authentication.component.html")).default,
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! ./authentication.component.scss */ "./src/app/components/authentication/authentication.component.scss")).default]
    })
...
CourseComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-course',
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! raw-loader!./course.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/components/course/course.component.html")).default,
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! ./course.component.scss */ "./src/app/components/course/course.component.scss")).default]
    })
], CourseComponent);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "TaskInfoPage", function() { return TaskInfoPage; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
/* harmony import */ var _ionic_angular__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @ionic/angular */ "./node_modules/@ionic/angular/__ivy_ngcc__/fesm2015/ionic-angular.js");
/* harmony import */ var src_app_service_http_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! src/app/service/http.service */ "./src/app/service/http.service.ts");
...
Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()
], TaskInfoPage.prototype, "task", void 0);
TaskInfoPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-task-info',
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! raw-loader!./task-info.page.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/pages/task-info/task-info.page.html")).default,
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! ./task-info.page.scss */ "./src/app/pages/task-info/task-info.page.scss")).default]
    })
], TaskInfoPage);
...
let AuthService = class AuthService {
    ...
    getUser() {
        ...
        return this.http.get(baseUrl + 'sender/getUser', { headers });
    }
    logOut() {
...
/* harmony import */ var _data_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./data.service */ "./src/app/service/data.service.ts");
...
class EmailValidator {
    static confirmEmail(control, group, matchEmail) {
...
class PasswordValidator {
    static confirmPassword(control, group, matchPassword) {
        return new Promise(resolve => {
...
module.exports = __webpack_require__(/*! /Users/maximiliangrabner/Documents/Diplomarbeit/diplClientApp/appPTS/src/main.ts */"./src/main.ts");
